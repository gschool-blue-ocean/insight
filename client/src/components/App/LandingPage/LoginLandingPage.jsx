    ...
    <>
      ...
      >
        <div
          className={
            isDarkMode
              ? `bg-DGLogin bg-opacity-[0.8] w-full h-screen flex justify-center items-center`
              : `bg-LGLogin bg-opacity-[0.8] w-full h-screen flex justify-center items-center`
          }
        >
          <div
            id="loginContainer"
          ...
          >
            ...
            >
              <div id="loginTitle" className="flex items-center">
                {isDarkMode ? (
                  <img src="/assets/LogoDM.svg" alt="" id="Logo" />
                ) : (
                  <img src="/assets/LogoLM.svg" alt="" id="Logo" />
                )}
                <h1
                  className={
                    isDarkMode
