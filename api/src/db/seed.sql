...
INSERT INTO passwords (password, userId, token, expiration_date) 
VALUES 
    ('$2b$10$AEYCw0WmKHdj3DKi1.94QelhQ28KeVisxk9XJ2FVFgZp8VQ3S0o0O', 1, 'this is a test JWT', DATE '2023-09-01 00:00:00'),
    ('$2b$10$oj6cVKykXaBXmi47NZWFMuIrknLVCFdlIxf/1aRqwrbw/B.ArrfJ.', 2, 'this is a test JWT', DATE '2023-09-01 00:00:00'),
    ('$2b$10$fbRPquGm/6BLLTJW9oRQuuKAN25mckxXYSHIYVA.6N5GxXvt15TKu', 3, 'this is a test JWT', DATE '2023-09-01 00:00:00'),
    ('$2b$10$/bEcJM4c1xu48CfWYt6eWuBjmC9CjXs9CSGSq3uJCBXK7tRQrG59m', 4, 'this is a test JWT', DATE '2023-09-01 00:00:00');
